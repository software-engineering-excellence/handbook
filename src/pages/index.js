...
const features = [
  {
    ...
    description: (
      <>
        Code reviews not only need to be given effectively, it is also important
        to know how to receive them well.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        A deep-dive into five techniques; their typical use-cases, effectiveness
        and how to practice these techniques remotely.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        The moment you add a feature flag, it becomes a tech debt. Learn when
        and how to best use them in this chapter.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Using techniques such as Rubber Duck Debugging effectively will make you
        a better developer.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Have you found yourself in a situation where a refactor broke your
        entire system, then this chapter is for you.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Branch-Based Testing (BBT), also know as deployment previews, is the
        practice of testing new code in ephemeral environments.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        An important part of the software development workflow, which can
        greatly improve the team’s efficiency, if executed correctly.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Unless you work on private projects, most software you write needs to be
...
function Home() {
  ...
  return (
    <Layout description="Proven practices for developing software successfully">
